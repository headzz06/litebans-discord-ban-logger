...
public class DelMute extends Entry {
    private String reason;

    public DelMute(final String playerName, final litebans.api.Entry entry) {
    ...
    @Override
    public void execute() {
        super.embedBuilder.setTitle("New Unmute").addField(GenericMessages.USERNAME, super.getPlayerName(), false)
