...
public class AddMute extends Entry {
    private final String duration;
    private final String reason;

    public AddMute(final String playerName, final litebans.api.Entry entry) {
    ...
    @Override
    public void execute() {
        super.embedBuilder.setTitle("New Mute").addField(GenericMessages.USERNAME, super.getPlayerName(), false)
