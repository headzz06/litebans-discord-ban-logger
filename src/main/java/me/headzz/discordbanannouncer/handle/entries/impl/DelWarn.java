...
public class DelWarn extends Entry {
    ...
    public void executeDiscordWebhook() {
        WebhookUtils.newWebhookUtils(Utilities.getInstance().getWebhookURL()).execute(String.format("{\"content\":null,\"embeds\":[{\"title\":\"New Unwarn\",\"color\":%s,\"fields\":[{\"name\":\"%s\",\"value\":\"%s\"},{\"name\":\"%s\",\"value\":\"%s\",\"inline\":true},{\"name\":\"%s\",\"value\":\"%s\",\"inline\":true}],\"thumbnail\":{\"url\":\"%s\"}}],\"attachments\":[]}", WebhookColors.GREEN.getHexCode(),
